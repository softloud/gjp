...
- `opts_n` contains the number of options, this dataset has been filtered for 2 options only. 
- `q_conditional` indicates 1 if the question text `options` field begins with `If` and 0 if it begins with something else   
