...
Here's what I _think_ I understand.

We want to know if the user answered the question correctly, and have this as a variable with 0 for incorrect and 1 for correct.

Now, in the questions dataset, there is a the outcome option.
...
write_csv(output_data, "data-raw/forecast_data.csv")
